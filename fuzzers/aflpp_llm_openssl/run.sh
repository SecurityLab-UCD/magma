...
# --fuzzing_object 'bignum' --if_text True 
accelerate launch --mixed_precision fp16 "$FUZZER/repo/structureLLM/llama2_mutator.py" --fuzzing_target 'openssl' --fuzzing_object 'server' --temperature 1 &
